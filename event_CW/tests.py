...
from openstack_dashboard.dashboards.admin.event_CW import tabs
from openstack_dashboard.test import helpers as test

INDEX_URL = reverse("horizon:admin:event_CW:index")
...
class MeteringViewTests(test.APITestCase, test.BaseAdminViewTests):
    def test_stats_page(self):
        ...
        res = self.client.get(reverse('horizon:admin:event_CW:index') +
            "?tab=ceilometer_overview__stats")
        self.assertTemplateUsed(res, 'admin/event_CW/index.html')
        self.assertTemplateUsed(res, 'admin/event_CW/stats.html')
    ...
    def test_stats_for_line_chart(self):
        ...
        res = self.client.get(reverse('horizon:admin:event_CW:samples') +
